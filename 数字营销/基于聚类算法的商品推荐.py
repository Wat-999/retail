...
import pandas as pd
#导入订单数据
df_order = pd.read_csv('/Users/macbookair/Desktop/数据分析/书本配套资料及电子书/python商业数据分析(零售和电子商务)/《Python商业数据分析：零售和电子商务案例详解》/第五章Python与数字营销案例/data/orders.csv')
# 对数据进行探索分析。
#print(df_order.head())
#print(df_order.tail())
...
#导入订单商品数据
df_item = pd.read_csv('/Users/macbookair/Desktop/数据分析/书本配套资料及电子书/python商业数据分析(零售和电子商务)/《Python商业数据分析：零售和电子商务案例详解》/第五章Python与数字营销案例/Items_order.csv')
...
#print(items.head())
# 导入商品信息。
df_attr = pd.read_csv("/Users/macbookair/Desktop/数据分析/书本配套资料及电子书/python商业数据分析(零售和电子商务)/《Python商业数据分析：零售和电子商务案例详解》/第五章Python与数字营销案例/Items_attribute.csv", encoding='gb2312')
#print(df_attr.head())
df_attr.info()
